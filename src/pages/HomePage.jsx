  ...
  return (
    <main>
      ...
      <section className="border-y border-brand-whatsapp/20 bg-brand-whatsappDark px-4 py-8 text-brand-white sm:px-6 sm:py-10 lg:px-8">
        <Reveal className="mx-auto grid max-w-7xl items-center gap-5 text-center md:grid-cols-[84px_1fr_auto] md:text-left">
          <div className="mx-auto flex size-18 items-center justify-center rounded-full border border-brand-whatsapp/45 bg-brand-whatsapp/10 text-brand-whatsapp md:mx-0">
          ...
          <div>
            ...
            <h2 className="mx-auto mt-2 max-w-xl font-heading text-xl font-bold leading-tight text-brand-white sm:text-2xl md:mx-0 md:max-w-none">
              {t('home.whatsappTitle')}
            </h2>
            <p className="mx-auto mt-2 max-w-2xl text-sm leading-6 text-brand-white/90 sm:text-base md:mx-0">
              {t('home.whatsappText')}
            </p>
          </div>
          <a
