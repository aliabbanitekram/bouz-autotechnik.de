  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        paragraphs: [
          'The responsible party for data processing on this website is: Bouz Autotechnik, Kölner Str. 11, 47805 Krefeld. Phone: +49 163 7991046. Email: info@bouz-autotechnik.de.',
          ...
          <div className="flex gap-10 xl:gap-16 items-start">
            ...
            <article className="min-w-0 max-w-3xl space-y-10">
              ...
              <section id="s3" data-privacy-section="true" className="scroll-mt-28">
                ...
                <p className="text-brand-steelDark text-sm leading-6 sm:text-base sm:leading-relaxed mt-2">Bouz Autotechnik<br />Kölner Str. 11<br />47805 Krefeld</p>
                <p className="text-brand-steelDark text-sm leading-6 sm:text-base sm:leading-relaxed mt-2">Telefon: <a href="tel:+491637991046" target="_blank" rel="noopener noreferrer" className="text-brand-red hover:underline break-all">+49 163 7991046</a><br />E-Mail: <a href="mailto:info@bouz-autotechnik.de" target="_blank" rel="noopener noreferrer" className="text-brand-red hover:underline break-all">info@bouz-autotechnik.de</a></p>
